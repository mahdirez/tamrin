const arrayInfo = [
  ...
  },
  {
    firstName: "luka",
    secondryName: "modric",
    avatar: "https://i.redd.it/72p3407p9w691.png",
    job: "football player",
  },
  {
    firstName: "steve",
    secondryName: "jobs",
    avatar:
      "https://cdn.imgbin.com/22/25/19/imgbin-icon-steve-jobs-the-second-coming-of-steve-jobs-steve-jobs-book-things-you-should-learn-from-steve-jobs-laserwriter-jobblackandwhite-MQ8e6Jx2NMcFNzbrwiJivR0TV.jpg",
    job: "programmer",
  },
  {
    firstName: "react",
    ...
    job: "framwork javaScript",
  },
  {
    firstName: "tibo",
    secondryName: "courtois",
    avatar: "https://cdn.futbin.com/content/fifa22/img/players/p100855415.png",
    job: "football player",
  },
];

function Users({name,family,work,img}) {
  return (
...
function Items() {
  return (
    <>
      {arrayInfo.map(({firstName,secondryName,avatar,job}) => {
        return <Users name={firstName} family={secondryName}  work={job} img={avatar} />
      })}
    </>
  );
}
